...
public class Book implements Serializable
{
    ...
    //constructor
    public Book(String pISBN, String book_title, String pBookAuthor, int pPublishedYear, String book_genre, String synopsis,int cover){
        ISBN = pISBN;
    ...
    //public int getBook_cover(){return book_cover;}
    //public void setBook_cover(int book_cover){this.book_cover = book_cover;}
